...
public class EditSelectedColorOutsideAction extends AbstractRudokAction{

    public EditSelectedColorOutsideAction(){
        putValue(SMALL_ICON, loadIcon("/images/editSelectedColor.png"));
        putValue(NAME, "Change Outside Color");
        putValue(SHORT_DESCRIPTION, "Change Outside Color");
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        for (Painter p: selectedPainters) {
            ...
            selectedElement.setColourOutline(hexColor);
        }
